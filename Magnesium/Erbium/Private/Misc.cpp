...
const std::unordered_map<std::string, std::string> Misc::ItemNames = {
	...
	{ "grappler", VersionInfo.FortniteVersion >= 12.50 ? "WID_Hook_Gun_Spytech_VR_Ore_T03" : (VersionInfo.FortniteVersion >= 7.10 ? "WID_Hook_Gun_Slide" : "WID_Hook_Gun_VR_Ore_T03") },
	{ "grapple", VersionInfo.FortniteVersion >= 12.50 ? "WID_Hook_Gun_Spytech_VR_Ore_T03" : (VersionInfo.FortniteVersion >= 7.10 ? "WID_Hook_Gun_Slide" : "WID_Hook_Gun_VR_Ore_T03") },
	{ "grap", VersionInfo.FortniteVersion >= 12.50 ? "WID_Hook_Gun_Spytech_VR_Ore_T03" : (VersionInfo.FortniteVersion >= 7.10 ? "WID_Hook_Gun_Slide" : "WID_Hook_Gun_VR_Ore_T03") },
