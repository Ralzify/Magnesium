...
const std::unordered_map<std::string, std::string> Misc::ItemNames = {
	...
	{ "grappler", VersionInfo.FortniteVersion < 12.50 && VersionInfo.FortniteVersion >= 7.10 ? "WID_Hook_Gun_Spytech_VR_Ore_T03" : "WID_Hook_Gun_Slide" },
	{ "grapple", VersionInfo.FortniteVersion < 12.50 && VersionInfo.FortniteVersion >= 7.10 ? "WID_Hook_Gun_Spytech_VR_Ore_T03" : "WID_Hook_Gun_Slide" },
	{ "grap", VersionInfo.FortniteVersion < 12.50 && VersionInfo.FortniteVersion >= 7.10 ? "WID_Hook_Gun_Spytech_VR_Ore_T03" : "WID_Hook_Gun_Slide" },
	{ "grappler", VersionInfo.FortniteVersion < 7.10 ? "WID_Hook_Gun_Slide" : "WID_Hook_Gun_VR_Ore_T03" },
	{ "grapple", VersionInfo.FortniteVersion < 7.10 ? "WID_Hook_Gun_Slide" : "WID_Hook_Gun_VR_Ore_T03" },
	{ "grap", VersionInfo.FortniteVersion < 7.10 ? "WID_Hook_Gun_Slide" : "WID_Hook_Gun_VR_Ore_T03" },
