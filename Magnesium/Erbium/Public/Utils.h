...
#else
#define InitHooks static void Hook(); static int _AddHook() { _HookFuncs.push_back(Hook); _HookNames.push_back(__FILE__); return 0; }; static inline auto _HookAdder = _AddHook();
#define InitPostLoadHooks static void PostLoadHook(); static int _AddPostLoadHook() { _PostLoadHookFuncs.push_back(PostLoadHook); _PostLoadHookNames.push_back(__FILE__); return 0; }; static inline auto _PostLoadHookAdder = _AddPostLoadHook();
#endif
