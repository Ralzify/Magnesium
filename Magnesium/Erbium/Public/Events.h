...
public:
    ...
    static inline std::vector<FEvent> EventsArray =
    {
        FEvent
        {
            nullptr, L"/Game/Athena/Maps/Test/Events/BP_GeodeScripting.BP_GeodeScripting_C",
            {
                FEventFunction{ false, L"/Game/Athena/Maps/Test/Events/BP_GeodeScripting.BP_GeodeScripting_C.LaunchSequence" }
            }, 4.5, nullptr, L"/Game/Athena/Playlists/Playlist_DefaultSolo.Playlist_DefaultSolo"
        }, FEvent
        {
            ...
            }, 5.30, nullptr, L"/Game/Athena/Playlists/Playlist_DefaultSolo.Playlist_DefaultSolo"
        }, FEvent
        {
            L"/Game/Athena/Prototype/Blueprints/Island/BP_Butterfly.BP_Butterfly_C", nullptr,
            {
        ...
        {
            nullptr, L"/Game/Athena/Prototype/Blueprints/White/BP_SnowScripting.BP_SnowScripting_C",
            {
        ...
        {
            nullptr, L"/Game/Athena/Events/NewYear/BP_NewYearTimer.BP_NewYearTimer_C",
            {
        ...
        }, FEvent
        {
            ...
            }, 17.30, nullptr, L"/BuffetPlaylist/Playlist/Playlist_Buffet.Playlist_Buffet"
        }, FEvent
        {
            nullptr, L"/Kiwi/Gameplay/Kiwi_EventScript.Kiwi_EventScript_C",
            {
                FEventFunction{ false, L"/Script/SpecialEventGameplayRuntime.SpecialEventScript.StartEventAtIndex" }
            }, 17.50, nullptr, L"/KiwiPlaylist/Playlists/Playlist_Kiwi.Playlist_Kiwi"
        }, FEvent
        {
            nullptr, L"/Guava/Gameplay/BP_Guava_SpecialEventScript.BP_Guava_SpecialEventScript_C",
            {
                FEventFunction{ false, L"/Script/SpecialEventGameplayRuntime.SpecialEventScript.StartEventAtIndex" }
            }, 18.40, nullptr, L"/GuavaPlaylist/Playlist/Playlist_Guava.Playlist_Guava"
        }, FEvent
        {
            nullptr,
            ...
            {
                FEventFunction{ false, L"/Script/SpecialEventGameplayRuntime.SpecialEventScript.StartEventAtIndex" }
            }, 20.40, nullptr, L"/ArmadilloPlaylist/Playlist/Playlist_Armadillo.Playlist_Armadillo"
        }, FEvent
        {
            nullptr,
            ...
            {
                FEventFunction{ false, L"/Script/SpecialEventGameplayRuntime.SpecialEventScript.StartEventAtIndex" }
            }, 22.40, nullptr, L"/Radish/Playlist/Playlist_Radish.Playlist_Radish"
        }, FEvent
        {
            nullptr,
            ...
            {
                FEventFunction{ false, L"/Script/SpecialEventGameplayRuntime.SpecialEventScript.StartEventAtIndex" }
            }, 27.11, nullptr, L"/DurianPlaylist/Playlist/Playlist_Durian.Playlist_Durian"
        }
    };
