...
public:
    ...
    static UObject* GetTimeOfDayControllerCompat(UObject* WorldContextObject);
    static bool GetTimeOfDayCompat(UObject* WorldContextObject, float& OutTimeOfDay);
    static bool GetTimeOfDaySpeedCompat(UObject* WorldContextObject, float& OutTimeOfDaySpeed);
    static bool SetTimeOfDayCompat(UObject* WorldContextObject, float TimeOfDay);
    static bool SetTimeOfDaySpeedCompat(UObject* WorldContextObject, float TimeOfDaySpeed);
    static bool SetResolvedTimeOfDaySpeedCompat(UObject* Controller, float TimeOfDaySpeed);
    ...
    static void GiveItemToInventoryOwner(UObject*, FFrame&, UFortWorldItem**);
    static bool IsGhostModeItemDefinition(const UFortItemDefinition*);
    static void NotifyGhostModeItemRemoved(AFortPlayerControllerAthena*,
        const UFortItemDefinition*);
    static bool CleanupGhostMode(AFortPlayerControllerAthena*, bool = true);
